...
import { NextCaller, LegacyMiddleware, Middleware } from "./Middleware/Middleware";

interface Signalable<CallArguments extends Array<unknown>, PlayerArgument extends defined> {
	Connect(callback: (player: PlayerArgument, ...args: CallArguments) => void): RBXScriptConnection;
}

class ServerEventV2<CallArguments extends Array<unknown> = Array<unknown>> implements NetManagedEvent, Signalable<CallArguments, Player> {
...
type EnhancedServerEventV2<
	...
	M2 = defined,
	M3 = defined,
> = M3 extends Middleware<infer A, infer _>
	? ServerEventV2<A>
...
export interface ServerEventV2Constructor {
	...
	new <M0 extends Middleware<any, any, any, any>, M1 extends Middleware<any, InferPrevType<M0>, any, InferPrevSender<M0>>>(
		name: string,
